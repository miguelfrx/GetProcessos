...
<div class="p-4 sm:ml-64 mt-20">
    <div class="p-6 bg-white/90 backdrop-blur-md rounded-xl shadow-xl border border-gray-200">
        ...
        @php
            ...
            // Estado anterior do histórico
            $ultimoHistorico = $cadastro->historico()->latest('data_hora')->first();
            $estadoAnteriorDescricao = $ultimoHistorico 
                ? $ultimoHistorico->estadoAnterior->descricao 
                : 'Sem Estado';

            $corAtual = $cores[$estadoAtualDescricao] ?? 'cinzento';
            $corAnterior = $cores[$estadoAnteriorDescricao] ?? 'cinzento';
        @endphp
...
<div class="mb-4 flex items-center gap-2">
    ...
    <span class="badge 
                 estado-{{ strtolower(str_replace(' ', '', $corAtual)) }}" 
