    ...
    <div class="relative overflow-x-auto bg-white shadow rounded border border-gray-200">
        ...
        <div class="p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <form method="GET" action="{{ url('/todos-cadastros') }}" class="flex gap-2 items-center flex-wrap">
                ...
                <select name="estado" class="px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring focus:border-blue-500">
                ...
                <button type="submit" class="px-3 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Filtrar</button>
            </form>
        </div>
        ...
        <table class="w-full text-left text-sm text-gray-700">
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50">
                    <td class="px-4 py-2">{{ $loop->iteration }}</td> <!-- Número da linha -->
